...
parser.add_argument('--img_size', type=int, default=128, help='PN Image Size')
...
for epoch in range(start_epoch, start_epoch+args.max_epochs+1):
    ...
    # with open('./save_graph/256_A2C_demo/epochs.txt', 'wb') as f:
    #     pickle.dump(epochs, f)
    # with open('./save_graph/256_A2C/rewards.txt', 'wb') as f:
    #     pickle.dump(train_rewards, f)
    # with open('./save_graph/256_A2C/avg_rewards.txt', 'wb') as f:
    #     pickle.dump(avg_rewards, f)
    # with open('./save_graph/256_A2C_demo/ap.txt', 'wb') as f:
    #     pickle.dump(ap, f)
    # with open('./save_graph/256_A2C_demo/ar.txt', 'wb') as f:
    #     pickle.dump(ar, f)
    # with open('./save_graph/256_A2C_demo/actions.txt', 'wb') as f:
    #     pickle.dump(test_actions, f)
    # with open('./save_graph/256/losses.txt', 'wb') as f:
