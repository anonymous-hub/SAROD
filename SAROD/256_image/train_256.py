...
for epoch in range(start_epoch, start_epoch+args.max_epochs+1):
    ...
    with open('./save_graph/256/epochs.txt', 'wb') as f:
        pickle.dump(epochs, f)
    with open('./save_graph/256/rewards.txt', 'wb') as f:
        pickle.dump(train_rewards, f)
    with open('./save_graph/256/avg_rewards.txt', 'wb') as f:
        pickle.dump(avg_rewards, f)
    with open('./save_graph/256/ap.txt', 'wb') as f:
        pickle.dump(ap, f)
    with open('./save_graph/256/ar.txt', 'wb') as f:
        pickle.dump(ar, f)
    with open('./save_graph/256/actions.txt', 'wb') as f:
