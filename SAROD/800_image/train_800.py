...
from constants_800 import base_dir_metric_cd, base_dir_metric_fd
from constants_800 import num_actions
...
for epoch in range(start_epoch, start_epoch+args.max_epochs+1):
    ...
    with open('./save_graph/800_vanila/epochs.txt', 'wb') as f:
        pickle.dump(epochs, f)

    with open('./save_graph/800_vanila/rewards.txt', 'wb') as f:
        pickle.dump(train_rewards, f)

    with open('./save_graph/800_vanila/avg_rewards.txt', 'wb') as f:
        pickle.dump(avg_rewards, f)

    with open('./save_graph/800_vanila/ap.txt', 'wb') as f:
        pickle.dump(ap, f)

    with open('./save_graph/800_vanila/ar.txt', 'wb') as f:
        pickle.dump(ar, f)

    with open('./save_graph/800_vanila/actions.txt', 'wb') as f:
        pickle.dump(test_actions, f)

    with open('./save_graph/800_vanila/losses.txt', 'wb') as f:
    ...
    pylab.savefig("./save_graph/800_vanila/graph.png")
    ...
    pylab.savefig("./save_graph/800_vanila/graph_precision.png")
    ...
    pylab.xlabel("epoch")
    pylab.ylabel("recall")
    pylab.savefig("./save_graph/800_vanila/graph_recall.png")

    pylab.cla()

    pylab.plot(epochs, avg_rewards, 'b', label='loss')
...
#     pylab.plot(epochs, train_loss, 'b', label='train loss')
    ...
    pylab.savefig("./save_graph/800_vanila/graph_summary.png")
